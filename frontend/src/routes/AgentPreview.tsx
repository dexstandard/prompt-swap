    ...
    return (
        <div className="p-4">
            ...
            <div className="mt-4">
                ...
                <WarningSign>
                    Trading agent will manage all available balance
                    for {agentData.tokenA.toUpperCase()} and {agentData.tokenB.toUpperCase()} in
                    your Binance Spot wallet. Move excess funds to futures wallet before trading.
                    <br/>
                    <strong>DON'T MOVE FUNDS ON SPOT WALLET DURING TRADING!</strong> It will confuse the trading agent
                    and may
